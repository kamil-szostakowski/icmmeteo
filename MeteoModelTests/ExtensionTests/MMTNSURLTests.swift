...
class MMTNSURLTests: XCTestCase
{
    ...
    func testMeteorogramSearchUrl()
    {
        ...
        let expectedUrl_UM = "http://www.meteo.pl/um/php/mgram_search.php?NALL=53.585869&EALL=19.570815&lang=en"
    ...
    {
        let expectedUrl_UM = "http://www.meteo.pl/um/metco/leg_um_en_cbase_256.png"
        let expectedUrl_COAMPS = "http://www.meteo.pl/metco/leg4_en.png"
